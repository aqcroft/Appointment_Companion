const CACHE_NAME = 'appointment-companion-consolidated-v1-6';
const SHELL = [
  './', './index.html', './manifest.webmanifest', './pwa-register.js', './tariff-fetch-v1.js',
  './canonical-state-v1.js', './canonical-controls-v1.js', './service-ui-polish-v1.js', './local-customer-store-v2.js',
  './consolidated-controller-v1.js', './share-policy-v1.js', './specialist-share-v1.js',
  './specialist-launcher-v1.js', './specialist-features-v1.js', './toolbar-polish-v1.js',
...
self.addEventListener('activate', function (event) { event.waitUntil(caches.keys().then(function (keys) { return Promise.all(keys.filter(function (key) { return key.indexOf('appointment-companion-consolidated-v1-') === 0 && key !== CACHE_NAME; }).map(function (key) { return caches.delete(key); })); }).then(function () { return self.clients.claim(); })); });
