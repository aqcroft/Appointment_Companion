const CACHE_NAME = 'appointment-companion-consolidated-v2-1';
const SHELL = [
  './', './index.html', './manifest.webmanifest', './pwa-register.js', './tariff-fetch-v1.js',
  './canonical-state-v1.js', './canonical-controls-v1.js', './service-ui-polish-v1.js', './spring-clean-v2.js', './local-customer-store-v2.js',
