...
(function (global) {
  ...
  var EV_TOP = new Set(('schema_version view_type customer_name basket_url electricityUsageTotalKwh electricityProfile electricityUsageDayKwh electricityUsageNightKwh ev_state').split(' '));
