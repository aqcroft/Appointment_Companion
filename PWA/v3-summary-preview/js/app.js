import { VERSION } from '../../v3.03/js/config/version.js';
import { TOOLS } from '../../v3.03/js/config/tools.js';
import { calculateAppointment } from '../../v3.03/js/appointment/calculations.js';
import { appointmentCompleteness, markComparisonFieldEntered, mobilePlanPrice } from '../../v3.03/js/appointment/completeness.js';
import { calculateAnnualDayNightSplit, calculateEconomy7AnnualCost } from '../../v3.03/js/energy/split-helper.js';
import { UW_RULES_2026_10_01 } from '../../v3.03/js/rules/uw-rules-2026-10-01.js';
import { createAppointment, createSim, clone, normaliseAppointment, normaliseName, REGIONS } from '../../v3.03/js/state/canonical-state.js';
import { customerStore } from '../../v3.03/js/state/customer-store.js';
import { getCloudAuth, setCloudAuth, syncAll, markDeleted, resolveConflict } from '../../v3.03/js/state/cloud-sync.js';
import { buildShareData, buildShareUrl, decodeShareData, figuresText } from '../../v3.03/js/summary/share-data.js';
import { createSummaryActivity, summaryHistory } from '../../v3.03/js/summary/history.js';
import { UnsavedWorkGuard } from '../../v3.03/js/shell/unsaved-work-guard.js';
import { launchTool } from '../../v3.03/js/specialists/launcher.js';
import { loadTariffs, TARIFF_FEED_URL } from '../../v3.03/js/data/tariff-client.js';
import { buildIndicativeTiers, buildTariffGrid, calculateIndicativeEnergyCost } from '../../v3.03/js/energy/indicative-cost.js';
import { buildMealDealPreview } from '../../v3.03/js/appointment/upgrade-preview.js';
import { safeHttps } from '../../v3.03/js/summary/share-policy.js';
...
function summaryOutcomeHero(result, name = '', preview = false) {
  const monthly = result.effectiveMonthlySaving ?? result.monthlyServiceSaving ?? 0;
  ...
  return `<section class="summary-outcome-card ${positive ? 'positive' : 'negative'}">
    ...
    <div class="summary-outcome-mark" aria-hidden="true">✓</div>
  </section>`;
}
...
function renderSummary() {
  ...
  window.scrollTo(0, 0);
  app.innerHTML = `<div class="summary-page partner-summary summary-v3-overhaul">
