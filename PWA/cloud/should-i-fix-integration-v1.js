/* Should I Fix integration shim v1
   Adds a dedicated main-menu icon and registers the existing Should I Fix
   calculator as a specialist Companion without changing the core launcher.
*/
(function (global) {
  'use strict';
